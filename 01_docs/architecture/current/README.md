...
Enterprise ETL runtime được gắn vào đâu
...
2. [final_enterprise_etl_runtime_architecture.md](final_enterprise_etl_runtime_architecture.md) - giải thích kiến trúc chi tiết.
3. [final_enterprise_etl_runtime_architecture.svg](final_enterprise_etl_runtime_architecture.svg) - hình kiến trúc chính.
...
| [readme_enterprise_etl_loader_contract.svg](readme_enterprise_etl_loader_contract.svg) | [readme_enterprise_etl_loader_contract.mmd](readme_enterprise_etl_loader_contract.mmd) | `_Wrk` view, final table, wrapper và Enterprise ETL loader liên kết ra sao. |
...
- Phase 1 đã hoàn tất theo hướng Enterprise ETL-aligned cho scope SupplyChain hiện tại.
