...
Nếu root `README.md` là bản đồ tổng quan, thì `01_docs/` là nơi giải thích sâu hơn: kiến trúc, onboarding, tài liệu BOB, quyết định kiến trúc, runbook và kế hoạch migration.
...
| Muốn hiểu tài liệu BOB được áp dụng ra sao | [bob-framework/README.md](bob-framework/README.md) |
...
| [bob-framework/](bob-framework/) | Tài liệu BOB gửi, kèm cách hiểu và áp dụng vào SupplyChain. |
...
- [ADR-010: BOB Wrapper Runtime Handoff For Phase 1](decisions/ADR-010-bob-wrapper-runtime-handoff.md)
