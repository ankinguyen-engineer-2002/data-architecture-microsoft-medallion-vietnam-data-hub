...
CREATE   PROCEDURE [dbo].[Usp_Refresh_InventoryHealth_Silver_W02]
AS
BEGIN
    SET NOCOUNT ON;
    ...
    EXEC [ETL_Framework].[DW_Developer].[usp_UpdateCuratedTableFromView_DateRange]
        'SupplyChain_Processing_Warehouse', 'InventoryHistory_Enh', 'ForecastSnapshotWeekly', 'SnapshotDate', 'SnapshotDate', -90;

    EXEC [ETL_Framework].[DW_Developer].[usp_UpdateCuratedTableFromView_DateRange]
        'SupplyChain_Processing_Warehouse', 'InventoryHistory_Enh', 'SupplyPlanDetail', 'SnapshotDate', 'SnapshotDate', -90;
