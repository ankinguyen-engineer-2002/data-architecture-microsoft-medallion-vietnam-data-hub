...
| 21 | `Staging_Wrk.DemandForecastSnapshotDaily` | Active forecast weekly snapshot path via Saturday daily rows | Active DA-first path; staging wrapper over daily forecast snapshot data |
