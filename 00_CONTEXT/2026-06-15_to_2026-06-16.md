# Context 2026-06-15 to 2026-06-16
...
Folder: `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/20260611_161739_martA_fix/`
...
- Updated to reflect `SupplyChain_Enh` path:
  - `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/projects/forecast/etl/staging_ddl.sql`
  - `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/projects/forecast/etl/silver_views.sql` (comment text)
  - `01_docs/decisions/ADR-002-edw-supplement-exit-strategy.md`
  - `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/projects/forecast/10_bronze.md` (note legacy DF2 supplement)
...
Folder: `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/20260611_182800_martA_fix_v2/`
...
Folder: `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/20260611_190000_martA_fix_livecheck/`
...
3) **Update documentation** sau khi fix xong:
   - Update `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/projects/forecast/50_semantic.md` + `projects/live_audit_2026-06-01.md` (nếu cần) để reflect clean model + new snapshot source.
...
- Changes are reversible via backups under `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/`. [Verified]
...
- [Added] `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/05_tools/fix_v10_inventory_project_taxonomy.py`
...
- [Added] `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/projects/live_audit_2026-06-15_v10_core_stack.md`

Updated:

- `README.md`
- `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/INDEX.md`
- `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/projects/README.md`
- `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/projects/forecast/README.md`
- `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/projects/forecast/40_pipelines.md`
- `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/projects/forecast/50_semantic.md`
- `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/projects/inventory_health/README.md`
- `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/projects/inventory_health/20_silver.md`
- `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/projects/inventory_health/30_gold.md`
- `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/projects/inventory_health/40_pipelines.md`
- `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/projects/inventory_health/50_semantic.md`
- `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/30_runbook/18_v10_da_table_onboarding.md`

### 6.3 Build-run artifacts / evidence folders created

- `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/20260615_094135_inventory_project_taxonomy_fix/`
- `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/20260615_094204_inventory_project_taxonomy_fix/`
- `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/20260615_094323_inventory_project_taxonomy_fix/`
...
- [Added] `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/05_tools/healthcheck_v10_control_plane.py`
  - mục tiêu: đóng vai “test” (RED→GREEN) cho control-plane, **read-only** (không mutate live)
- [Added] `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/05_tools/fix_v10_control_plane_hardening.py`
...
- command:
  - `python3 99_archive/reverse-engineering/enterprise_supplychain_dev_architect/05_tools/fix_v10_inventory_project_taxonomy.py --verify-only`
- output dir:
  - `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/20260615_101713_inventory_project_taxonomy_fix/`
- key results:
...
- command:
  - `python3 99_archive/reverse-engineering/enterprise_supplychain_dev_architect/05_tools/healthcheck_v10_control_plane.py`
- results (PASS/FAIL):
...
- `python3 99_archive/reverse-engineering/enterprise_supplychain_dev_architect/05_tools/fix_v10_control_plane_hardening.py`
...
- `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/20260615_111417_v10_control_plane_hardening/`
- `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/20260615_111629_v10_control_plane_hardening/`
...
5) Lineage extraction + semantic edges — [Verified drift exists]
   - rà lại `03_operations/apps/lineage_explorer/export_lineage_data.py` (default semantic model IDs/names đang stale so với live `sc_control_tower` state)
...
- Repo change executed:
  - Updated: `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/05_tools/fix_v10_control_plane_hardening.py`
    - backfill now:
...
- Ran (read-only): `python3 99_archive/reverse-engineering/enterprise_supplychain_dev_architect/05_tools/fix_v10_control_plane_hardening.py --verify-only`
  - output_dir: `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/20260615_124852_v10_control_plane_hardening/`
...
```bash
python3 99_archive/reverse-engineering/enterprise_supplychain_dev_architect/05_tools/fix_v10_control_plane_hardening.py --tabledict-only
```

Expected verification (read-only):

```bash
python3 99_archive/reverse-engineering/enterprise_supplychain_dev_architect/05_tools/healthcheck_v10_control_plane.py --json
```
...
- Ran live mutation script (SQL only; no pipeline updates):  
  - `python3 99_archive/reverse-engineering/enterprise_supplychain_dev_architect/05_tools/fix_v10_control_plane_hardening.py --tabledict-only`
  - output_dir: `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/20260615_125406_v10_control_plane_hardening/`
...
- Ran (read-only): `python3 99_archive/reverse-engineering/enterprise_supplychain_dev_architect/05_tools/healthcheck_v10_control_plane.py --json`
  - confirmed:
...
- Ran (no live mutation):  
  - `python3 99_archive/reverse-engineering/enterprise_supplychain_dev_architect/05_tools/fix_v10_control_plane_hardening.py --pipelines-only --pipelines-dry-run`
  - output_dir: `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/20260615_125819_v10_control_plane_hardening/`
- Generated reviewable payloads (no apply):
  - `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/20260615_125819_v10_control_plane_hardening/pipeline_patch/pl_sc_mart_updateDefinition_body.json`
  - `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/20260615_125819_v10_control_plane_hardening/pipeline_patch/pl_sc_silver_wave_updateDefinition_body.json`
  - `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/20260615_125819_v10_control_plane_hardening/pipeline_patch/pl_sc_gold_updateDefinition_body.json`
...
- Ran (live Fabric updateDefinition):  
  - `python3 99_archive/reverse-engineering/enterprise_supplychain_dev_architect/05_tools/fix_v10_control_plane_hardening.py --pipelines-only`
  - output_dir: `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/20260615_130110_v10_control_plane_hardening/`
  - result: `healthcheck_ok=true`
- Independent QC (read-only):
  - `python3 99_archive/reverse-engineering/enterprise_supplychain_dev_architect/05_tools/healthcheck_v10_control_plane.py --json` → `ok=true`
...
- Applied live Fabric updateDefinition (pipelines-only):
  - `python3 99_archive/reverse-engineering/enterprise_supplychain_dev_architect/05_tools/fix_v10_control_plane_hardening.py --pipelines-only`
  - output_dir: `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/20260615_133309_v10_control_plane_hardening/`
...
- Commands executed (read-only intent):
  - `python3 99_archive/reverse-engineering/enterprise_supplychain_dev_architect/05_tools/fix_v10_inventory_project_taxonomy.py --verify-only`
    - output_dir: `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/20260615_134551_inventory_project_taxonomy_fix/`
  ...
  - `python3 99_archive/reverse-engineering/enterprise_supplychain_dev_architect/05_tools/fix_v10_control_plane_hardening.py --verify-only`
    - output_dir: `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/20260615_134636_v10_control_plane_hardening/`
    - result: `healthcheck_ok=true`
...
- Evidence folder:
  - `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/20260615_135450_job_scheduler_snapshot/`
...
- Evidence folder:
  - `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/20260615_135903_semantic_snapshot/`
- Repo tool added (read-only helper):
  - `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/05_tools/snapshot_fabric_item_definitions.py`
- Actions executed:
  1) Fabric REST:
...
- Evidence folder created:
  - `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/20260615_143508_inventoryhealth_3layer_snapshot/`
...
- Evidence folder:
  - `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/20260615_144951_wave_autosplit_check/`
...
- Tightened `.gitignore` to hide local caches + run artifacts (`.azure*`, `01_docs/runbook/artifacts/`, `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/build_runs/`, `**/.workspace-info`, ...).
...
- [Verified] `EnterpriseData-Dev` workspace id found in `99_archive/reverse-engineering/enterprise_data_architect/INDEX.md`: `5360a935-1984-4775-895f-f4c90bafa19d`.
...
- Re-read project comparison docs:
  ...
  - `99_archive/reverse-engineering/enterprise_data_architect/10_evidence/03_orchestration_summary.md`
...
- [Verified] For 04_semantic/TMDL structure claims in this compare turn, fallback evidence comes from:
  - existing repo TMDL backups under `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/projects/forecast/artifacts/backups/...`
...
- Scanned WS1 source/code:
  - `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/projects/forecast/etl/meta_sps.sql`
  - `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/detail_clone_v9_forecast/20260501_093155/sql_definitions/routines/meta/usp_generic_load.sql`
  - `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/artifacts/v8_to_v10_parity/v10_views/Meta__vw_SilverWaveRuntime.sql`
  - `03_operations/apps/lineage_explorer/export_lineage_data.py`
...
- [Verified] `03_operations/apps/lineage_explorer/export_lineage_data.py` explicitly treats `AssetRegistry.source_objects + depends_on` as the ETL lineage source of truth and warns that `Meta.LineageEdge` can lag/stale for direct ETL lineage.
...
- Reused existing repo diagrams:
  - `99_archive/reverse-engineering/enterprise_data_architect/diagrams/cross_workspace_architecture.png`
  - `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/diagrams/render_check/02_main_architecture.svg`
  - `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/diagrams/render_check/03_control_plane.svg`
  - `99_archive/reverse-engineering/enterprise_supplychain_dev_architect/diagrams/render_check/22_control_plane_detail.svg`
