...
> Scope locked to the live v10 architecture in workspace `Enterprise SupplyChain-Dev` (`c8d9fc83-18b6-4e1d-8264-0b49eed36fe0`): `Enterprise_Lakehouse`, `SupplyChain_Processing_Warehouse`, `SupplyChain_Gold_Warehouse`, the `pl_sc_*` orchestration chain, and the live 04_semantic/report layer.
>
> Evidence source mix:
