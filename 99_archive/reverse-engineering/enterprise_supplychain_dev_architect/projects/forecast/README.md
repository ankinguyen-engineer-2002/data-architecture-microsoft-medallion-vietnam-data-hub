...
Per Bob's reply email 2026-05-09 + scan of `EnterpriseData-Dev` workspace (see `_external_refs/enterprisedata-dev-01_docs/`), the following changes were made unilaterally (no Bob block needed) — see [ADR-008](../../../docs/decisions/ADR-008-bob-alignment-naming-and-integration.md):
