...
|---|---|---|---|---|
| B1 | `SupplyChain_Enh_1.DemandForecastSnapshotWeekly` (LastSnap 2024-03-25) | **2.1 năm** | Active flow bypasses it with DA `ForecastSnapshotWeekly` from `Staging.DemandForecastSnapshotDaily` Saturday rows | Do not use stale weekly source |
