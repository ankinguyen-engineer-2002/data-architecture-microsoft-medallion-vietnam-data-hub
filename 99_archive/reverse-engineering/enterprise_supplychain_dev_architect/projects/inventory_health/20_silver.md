...
| `ForecastSnapshotWeekly` | `v_ForecastSnapshotWeekly` | overwrite | `Staging.DemandForecastSnapshotDaily` Saturday rows; `ForecastQty = ResultantForecast + PromotionalLift` |
