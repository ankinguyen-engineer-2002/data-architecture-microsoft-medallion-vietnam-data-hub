...
|---|---:|---|---|
| `InventoryHealth_DW.DimItem` | 383,371 | Stale physical table from pre-shared `DimProduct` flow. | Drop candidate after 04_semantic/report review; semantic now uses `DimProduct`. |
