...
MODULE_PATH = Path(__file__).with_name("build_phase1_bob_execution_pack.py")
SPEC = importlib.util.spec_from_file_location("build_phase1_bob_execution_pack", MODULE_PATH)
...
class BuildPhase1BobExecutionPackTests(unittest.TestCase):
    def test_normalize_dependencies_rewrites_incremental_commands(self) -> None:
        manifest_rows = [
            {
                ...
                "bob_exec_command": "PENDING_BOB_INCREMENTAL_PATH::SupplyChain_Processing_Warehouse.Staging.DemandForecastSnapshotDaily",
            ...
            },
            {
                ...
                "bob_exec_command": "EXEC DW_Developer.usp_RefreshCuratedTableFromView 'SupplyChain_Processing_Warehouse', 'ForecastHistory_Enh', 'ForecastDemandMonthly'",
            ...
            },
            {
                ...
                "bob_exec_command": "EXEC DW_Developer.usp_RefreshCuratedTableFromView 'SupplyChain_Processing_Warehouse', 'InventoryHistory_Enh', 'HoldingTransferSnapshotDaily'",
                "is_manual_run_enabled": "True",
                "load_type": "datekey",
                "wave_found": "True",
            },
            {
                ...
                "bob_exec_command": "EXEC DW_Developer.usp_RefreshCuratedTableFromView 'SupplyChain_Processing_Warehouse', 'InventoryHistory_Enh', 'ManufacturingOrderSnapshotDaily'",
                "is_manual_run_enabled": "True",
                "load_type": "datekey",
                "wave_found": "True",
            },
        ...
        self.assertEqual(
            by_asset["Staging.DemandForecastSnapshotDaily"]["bob_exec_command"],
        ...
        self.assertEqual(
            by_asset["InventoryHistory_Enh.HoldingTransferSnapshotDaily"]["bob_exec_command"],
        ...
        self.assertEqual(
            by_asset["InventoryHistory_Enh.ManufacturingOrderSnapshotDaily"]["bob_exec_command"],
        ...
        manifest_rows = [
            {
                ...
                "depends_on": "",
                "source_objects": "",
                "bob_exec_command": "REGISTER_ONLY::Enterprise_Lakehouse.bronze.brz_example",
                "is_manual_run_enabled": "True",
                "load_type": "overwrite",
                "wave_found": "False",
            },
            {
                ...
                "depends_on": "",
                "source_objects": "",
                "bob_exec_command": "EXEC DW_Developer.usp_IncrementalTableLoad 'SupplyChain_Processing_Warehouse', 'Staging', 'DemandForecastSnapshotDaily', 'NULL'",
                "is_manual_run_enabled": "False",
                "load_type": "incremental",
                "wave_found": "False",
            },
            ...
            },
            {
                ...
                "source_objects": "",
                "bob_exec_command": "EXEC DW_Developer.usp_RefreshCuratedTableFromView 'SupplyChain_Gold_Warehouse', 'ForecastAccuracy_DW', 'FactForecastActual'",
                "is_manual_run_enabled": "True",
                "load_type": "overwrite",
                "wave_found": "False",
            },
