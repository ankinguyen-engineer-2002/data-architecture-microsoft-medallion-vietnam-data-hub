-- Source: SupplyChain_Warehouse.silver.vw_slv_invoice_weekly
...
CREATE TABLE [silver].[vw_slv_invoice_weekly] (
    ...
    [qty_shipped] decimal(38,3) NULL,
    [amt_net_sales] decimal(38,3) NULL,
    [amt_invoice] decimal(38,2) NULL,
    [amt_freight] decimal(38,2) NULL,
