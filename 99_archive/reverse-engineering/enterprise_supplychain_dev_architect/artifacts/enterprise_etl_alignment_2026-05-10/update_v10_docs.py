"""Update v10 forecast docs to reflect Enterprise ETL alignment changes (2026-05-10).
...
Excludes:
  _open_questions_for_enterprise_etl.md (intentional historical reference)

Adds new sections to README.md about Enterprise ETL alignment infrastructure.
"""
...
EXCLUDE = {PROJ / "_open_questions_for_enterprise_etl.md"}
