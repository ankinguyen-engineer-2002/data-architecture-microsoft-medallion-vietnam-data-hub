...
-- Mirror Enterprise ETL's ETL_Framework.DW_Developer.TableDictionary schema (65 cols + 6 VN extensions = 71 total).
-- Also create Meta.TableDictionary_UpdateLog (clone of Enterprise ETL's update-log pattern).
