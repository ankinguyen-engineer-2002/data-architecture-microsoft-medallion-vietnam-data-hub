...
-- Port 3 procs from Enterprise ETL's ETL_Framework pattern, adapted to Meta schema:
...
-- Mirrors Enterprise ETL's [DW_Developer].[usp_UpdateTableDictionary_ModifiedDate]
--   Behaviour:
...
-- Mirrors Enterprise ETL's [DW_Developer].[usp_UpdateTableDictionaryModified]
