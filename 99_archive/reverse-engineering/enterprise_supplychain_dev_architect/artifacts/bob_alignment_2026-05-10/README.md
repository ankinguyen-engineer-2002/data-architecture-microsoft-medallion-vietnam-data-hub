...
Purpose: align v10 naming + metadata layer with Bob's actual `EnterpriseData-Dev` workspace pattern (scanned via `_external_refs/enterprisedata-dev-01_docs/`, gitignored).
