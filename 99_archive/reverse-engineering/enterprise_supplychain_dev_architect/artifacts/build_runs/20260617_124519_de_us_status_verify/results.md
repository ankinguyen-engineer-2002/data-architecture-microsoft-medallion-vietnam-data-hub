# DE US status verification — 20260617_124519_de_us_status_verify
...
- Exists: True
- Freshness: `RQIDT` max=20391225 (days_since=None)
- Errors: unsupported operand type(s) for -: 'datetime.date' and 'decimal.Decimal'
...
- Exists: True
- Freshness: `HDATE` max=20260617 (days_since=None)
- Errors: unsupported operand type(s) for -: 'datetime.date' and 'decimal.Decimal'
...
- Exists: True
- Freshness: `IPRMDT` max=20391225 (days_since=None)
- Errors: unsupported operand type(s) for -: 'datetime.date' and 'decimal.Decimal'
...
- Exists: True
- Freshness: `OTDATE` max=20210317 (days_since=None)
- Errors: unsupported operand type(s) for -: 'datetime.date' and 'decimal.Decimal'
...
- Exists: True
- Freshness: `ODUDT` max=1261231 (days_since=None)
- Errors: unsupported operand type(s) for -: 'datetime.date' and 'decimal.Decimal'
...
- Exists: True
- Freshness: `HARRDT` max=20280619 (days_since=None)
- Errors: unsupported operand type(s) for -: 'datetime.date' and 'decimal.Decimal'
...
- Exists: True
- Freshness: `MFSDT` max=20391101 (days_since=None)
- Errors: unsupported operand type(s) for -: 'datetime.date' and 'decimal.Decimal'
...
- Exists: True
- Freshness: `BZBLDT` max=1060826 (days_since=None)
- Errors: unsupported operand type(s) for -: 'datetime.date' and 'decimal.Decimal'
...
- Exists: True
- Freshness: `LACDT` max=1800305 (days_since=None)
- Errors: unsupported operand type(s) for -: 'datetime.date' and 'decimal.Decimal'
...
- Exists: False
- Errors: ('IMC06', '[IMC06] [Microsoft][ODBC Driver 18 for SQL Server]The connection is broken and recovery is not possible. The connection is marked by the client driver as unrecoverable. No attempt was made to restore the connection. (0) (SQLExecDirectW)')
...
- Exists: True
- Freshness: `WeekdayWeekend` max=Weekend (days_since=None)
- Errors: unsupported operand type(s) for -: 'datetime.date' and 'str'
