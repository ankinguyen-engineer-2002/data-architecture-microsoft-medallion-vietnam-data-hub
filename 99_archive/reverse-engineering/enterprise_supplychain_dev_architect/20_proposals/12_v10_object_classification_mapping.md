...
| `bronze.ref_calendar` | `REF` | `["Enterprise_Lakehouse.MasterData_DW.DimDate"]` | ReferenceMaster / NeedOwnerDecision | `DirectShortcutOrEnterpriseSilver` | EnterpriseData if reusable, else `SupplyChain_Processing_Warehouse.ReferenceMaster` | Likely reusable/reference; needs Enterprise ETL/Rakesh ownership decision |
| `bronze.ref_customer_account` | `REF` | `["Enterprise_Lakehouse.Customers.AccountMaster"]` | ReferenceMaster / NeedOwnerDecision | `DirectShortcutOrEnterpriseSilver` | EnterpriseData if reusable, else `SupplyChain_Processing_Warehouse.ReferenceMaster` | Likely reusable/reference; needs Enterprise ETL/Rakesh ownership decision |
| `bronze.ref_customer_account_group` | `REF` | `["Enterprise_Lakehouse.Wholesale_ProductSourcing_AFI.CustomerGrouping"]` | ReferenceMaster / NeedOwnerDecision | `DirectShortcutOrEnterpriseSilver` | EnterpriseData if reusable, else `SupplyChain_Processing_Warehouse.ReferenceMaster` | Likely reusable/reference; needs Enterprise ETL/Rakesh ownership decision |
| `bronze.ref_customer_grouping` | `REF` | `["Enterprise_Lakehouse.Wholesale_ProductSourcing_AFI.CustomerGrouping"]` | ReferenceMaster / NeedOwnerDecision | `DirectShortcutOrEnterpriseSilver` | EnterpriseData if reusable, else `SupplyChain_Processing_Warehouse.ReferenceMaster` | Likely reusable/reference; needs Enterprise ETL/Rakesh ownership decision |
| `bronze.ref_customer_shipping_location` | `REF` | `["Enterprise_Lakehouse.Customers.ShippingLocations"]` | ReferenceMaster / NeedOwnerDecision | `DirectShortcutOrEnterpriseSilver` | EnterpriseData if reusable, else `SupplyChain_Processing_Warehouse.ReferenceMaster` | Likely reusable/reference; needs Enterprise ETL/Rakesh ownership decision |
...
| `bronze.ref_item_master` | `REF` | `["Enterprise_Lakehouse.MasterData_DW.DimItemMaster"]` | ReferenceMaster / NeedOwnerDecision | `DirectShortcutOrEnterpriseSilver` | EnterpriseData if reusable, else `SupplyChain_Processing_Warehouse.ReferenceMaster` | Likely reusable/reference; needs Enterprise ETL/Rakesh ownership decision |
...
| `bronze.ref_product` | `REF` | `["bronze.ref_product_edw"]` | ReferenceMaster / `EDWSupplement_ExitCandidate` / NeedOwnerDecision | `EDWSupplement` initially; candidate for `DirectShortcut` or `EnterpriseSilver` | EnterpriseData if reusable, else `SupplyChain_Processing_Warehouse.ReferenceMaster` | V9 note marks EL `Ready`, but live v9 still uses `_edw`; requires dual-read validation and Enterprise ETL/Rakesh ownership decision |
...
| ReferenceMaster / NeedOwnerDecision | 7 REF | Likely reusable or shared; Enterprise ETL/Rakesh decision required |
