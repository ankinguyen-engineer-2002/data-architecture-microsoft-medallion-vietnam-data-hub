...
- Bob standards DOCX: `Enterprise_SupplyChain_Dev_architect/SQL Server Data Warehouse Standards.docx` (local-only evidence; intentionally ignored from Git unless sharing is approved)
